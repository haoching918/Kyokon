...
export function OAuthButton({ next = "/" }: OAuthButtonProps) {
  ...
  const handleSignIn = async () => {
    ...
    // PKCE flow: Supabase redirects to Google, then back to /auth/callback
    // where the server client exchanges the code for a session cookie.
